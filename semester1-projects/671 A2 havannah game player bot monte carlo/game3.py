...
from players.ai09 import AIPlayer
from players.ai02 import AIPlayer as AIPlayer2
...
def main():
    ...
    # Run the first game with player1 as 'ai' and player2 as 'ai2'
    print("Running Game 1: Player1 is 'ai', Player2 is 'ai2'")
    board = get_random_board(dim, blocks)
    Game('ai', 'ai2', make_player('ai', 1), make_player('ai2', 2), time, board, dim, mode)

    # Run the second game with player1 as 'ai2' and player2 as 'ai'
    print("Running Game 2: Player1 is 'ai2', Player2 is 'ai'")
    board = get_random_board(dim, blocks)
    Game('ai2', 'ai', make_player('ai2', 1), make_player('ai', 2), time, board, dim, mode)

    # Run the third game with random selection of player1 and player2
    print("Running Game 3: Random player selection")
    player1 = random.choice(['ai', 'ai2'])
    player2 = 'ai2' if player1 == 'ai' else 'ai'
    board = get_random_board(dim, blocks)
