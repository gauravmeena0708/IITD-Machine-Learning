...
class AIPlayer:
    def __init__(self, player_number: int, timer, simulations=200, logging_mode="no"):
        ...
        self.type = 'ai08'
        self.player_string = f'Player {player_number}: ai08'
        self.timer = timer
    ...
    def get_move(self, state: np.array) -> Tuple[int, int]:
        ...
        return random.choice(best_actions[:5])
