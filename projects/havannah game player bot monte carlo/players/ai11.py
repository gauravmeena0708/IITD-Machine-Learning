...
class AIPlayer:
    ...
    def __init__(self, player_number: int, timer):
        ...
        self.type = 'ai11'
        self.player_string = 'Player {}: ai11'.format(player_number)
        self.timer = timer
    ...
    def evaluate_action(self, state, action, neighbors, dim):
        ...
        potential to connect or block a win condition, with an emphasis on creating
        immediate winning opportunities like bridges, forks, or rings.
        """
        score = 0
        ...
        if win:
            if structure == "fork":
                score += 120  # Fork is extremely valuable
            elif structure == "bridge":
                score += 110  # Bridge is very valuable
            elif structure == "ring":
                score += 150  # Ring is the most valuable
